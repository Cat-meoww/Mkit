    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
      <div
        ...
        <div
          ...
          <div class="p-9">
            ...
            <div>
              <div class="form-control w-full ">
                ...
                <label class="label">
                  <span class="label-text bold">Document</span>
                  <span class="label-text-alt">Allowed valid JSON Only</span>
                </label>
                <textarea
                  on:keyup={enter}
                  bind:value={NewDoc}
                  ...
                  autocapitalize="off"
                  spellcheck="false"
                  class:textarea-error={err}
                  class="textarea w-full  textarea-bordered h-96 leading-5 font-medium font-mono"
                  placeholder={"{\n   key : value,\n   ...... \n}"} />
              </div>
            </div>
            <slot />
          ...
          {#if msg}
            <div class="px-9 ">
              <div class="text-red-600 border border-solid border-red-700 font-xs p-5">{msg}</div>
            </div>
          {/if}
          ...
          <div
            ...
            <button
              ...
              disabled={err}
              type="button"
              class="inline-flex w-full justify-center  rounded-md border border-transparent  px-4 py-2 text-base font-medium text-mongo-white shadow-sm hover:bg-mongo-green-hover hover:text-mongo-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
              >Insert</button>
            <button
              on:click={cancel}
              type="button"
