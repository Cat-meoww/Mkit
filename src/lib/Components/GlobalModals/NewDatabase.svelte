        ...
        <div
          ...
          <div class="p-9">
            ...
            <div>
              <div class="form-control w-full ">
                ...
                <label class="label">
                  <span class="label-text bold">Database Name</span>
                  <span class="label-text-alt"
                    >Allowed alphanumeric & UnderScore</span>
                </label>
                <input
                  bind:value={db}
                  type="text"
              ...
              <div class="form-control w-full ">
                <!-- svelte-ignore a11y-label-has-associated-control -->
                <label class="label">
                  <span class="label-text bold">Collection Name</span>
                  <span class="label-text-alt"
                    >Allowed alphanumeric & UnderScore</span>
                </label>
                <input
          ...
          <div
            ...
            <button
              on:click={submit}
              type="button"
              class="inline-flex w-full justify-center bg-mongo-green-btn rounded-md border border-transparent  px-4 py-2 text-base font-medium text-mongo-white shadow-sm hover:bg-mongo-green-hover hover:text-mongo-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
